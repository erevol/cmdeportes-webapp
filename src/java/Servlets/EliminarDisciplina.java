 ...
 */
@WebServlet(name = "EliminarDisciplina", urlPatterns = {"/EliminarDisciplina"})
public class EliminarDisciplina extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("isLogged") != null && (boolean) session.getAttribute("isLogged") == true){
            try {
                ...
                Gestor g = new Gestor();
                boolean esEliminado = g.modificarEstadoDisciplina(id);
