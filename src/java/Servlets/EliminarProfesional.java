 ...
 */
@WebServlet(name = "EliminarProfesional", urlPatterns = {"/EliminarProfesional"})
public class EliminarProfesional extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("isLogged") != null && (boolean) session.getAttribute("isLogged") == true){
            try {
                int id = Integer.parseInt(request.getParameter("idProfesional"));
                System.out.println("ID a eliminar " + id);
                Gestor g = new Gestor();
                boolean esEliminado = g.modificarEstadoProfesional(id);
