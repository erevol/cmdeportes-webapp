...
public class ModificarProfesional extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("isLogged") != null && (boolean) session.getAttribute("isLogged") == true){
            ...
            Gestor g = new Gestor();
            Profesional p = g.obtenerProfesionalPorId(idProfesional);
            System.out.println(p.toString());
            request.setAttribute("profesional", p);

            getServletContext().getRequestDispatcher("/ModificarProfesional.jsp").forward(request, response);
        } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("esto devuelve" + request.getParameter("idProfesional"));
        System.out.println("tipo devuelve " + request.getParameter("idTipo"));
        
        p.setIdProfesional(Integer.parseInt(request.getParameter("idProfesional")));
        ...
        p.setUrlFoto(request.getParameter("urlFoto"));
        
        Gestor g = new Gestor();
        boolean exito = g.modificarProfesional(p);
