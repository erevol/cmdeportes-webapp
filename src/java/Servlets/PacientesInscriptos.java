 ...
 */
@WebServlet(name = "PacientesInscriptos", urlPatterns = {"/PacientesInscriptos"})
public class PacientesInscriptos extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("isLogged") != null && (boolean) session.getAttribute("isLogged") == true){
            ...
            ArrayList<Paciente> pacientes = g.obtenerReportePacientesXDisciplina(idDisciplina);
            System.out.println(pacientes.toString());
            request.setAttribute("pacientes", pacientes);

            getServletContext().getRequestDispatcher("/PacientesInscriptos.jsp").forward(request, response);
        } else {
